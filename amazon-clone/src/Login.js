...
function Login() {
    ...
    const signIn = e => {
    e.preventDefault(); // preventDefult Helps not to refresh
    // Firebase Login ...
    ...
    return (
        <div className='login'>
            ...
            <div className="login__container">
                ...
                <p>
                    By signing-in you agree to this APP Conditions of Use & Sale. Please see our Privacy Notice, our Cookies Notice and our internet-Based Ads Notice.  
                </p>
